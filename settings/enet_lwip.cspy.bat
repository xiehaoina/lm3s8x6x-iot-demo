...
@REM    D:\program\IAR Systems\Embedded Workbench 5.0 Kickstart\common\plugins\CodeCoverage\CodeCoverage.dll
@REM    D:\program\IAR Systems\Embedded Workbench 5.0 Kickstart\common\plugins\Profiling\Profiling.dll
@REM    D:\program\IAR Systems\Embedded Workbench 5.0 Kickstart\common\plugins\stack\stack.dll
